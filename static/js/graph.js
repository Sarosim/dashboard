...
function show_gender_balance(ndx){
    ...
    dc.barChart("#gender-balance")
        ...
        //.elasticY(true) ez mindig felhúzza a grafikon legmagasabb oszlopát a max magasságig és hozzáigazítja az y tengely skálát
        .xAxisLabel("Gender")
        .yAxis().ticks(20);
}
...
function show_average_salaries(ndx){
    ...
    var averageSalaryByGender = dim.group().reduce(add_item, remove_item, intialise);
...
function show_rank_distribution (ndx) {
    ...
    dc.barChart("#rank-distribution")
        ...
        .stack(profByGender, "Assoc Prof")
        .stack(profByGender, "Asst Prof")
        .valueAccessor(function(d) {
            if(d.value.total > 0) {
...
function show_service_to_salary_correlation(ndx) {
    ...
    dc.scatterPlot("#service-salary")
        ...
        .margins({top: 10, right: 150, bottom: 75, left: 75});
}
